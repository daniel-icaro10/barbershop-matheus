...
export default function GlobalError({
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-10 px-5 bg-background">
      {/* Brand */}
      ...
      >
        ...
        <div className="flex w-full max-w-xs flex-col gap-3">
          ...
          <Link
            href="/"
            className="flex items-center justify-center gap-2 rounded-2xl border border-border/60 py-3.5 text-sm font-medium text-muted-foreground transition-colors hover:border-border hover:text-foreground"
          >
