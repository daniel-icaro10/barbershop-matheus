...
export function BookingReminderEmail({
  ...
  return (
    <Html lang="pt-BR">
      <Head />
      <Preview>Lembrete: seu horário é amanhã às {timeLabel} — {serviceName}</Preview>
        ...
        <Container style={{ maxWidth: 520, margin: "0 auto", padding: "32px 16px" }}>
          ...
          <Section style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <Text style={{ color: textBody, fontSize: 14, margin: 0 }}>
              Olá, {firstName}! Só lembrando do seu agendamento de amanhã.
            </Text>
          </Section>
            ...
            <div style={{ padding: "20px 24px" }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <tbody>
                  ...
                  <tr>
                    <td style={{ padding: "10px 0 0", verticalAlign: "top", width: "50%" }}>
                      <Text style={{ color: textMuted, fontSize: 9, fontWeight: 700, letterSpacing: "0.28em", textTransform: "uppercase", margin: "0 0 3px" }}>DATA</Text>
                      <Text style={{ color: "#ffffff", fontSize: 14, fontWeight: 600, margin: 0 }}>{dateLabel}</Text>
                    </td>
                    <td style={{ padding: "10px 0 0", verticalAlign: "top" }}>
                      <Text style={{ color: textMuted, fontSize: 9, fontWeight: 700, letterSpacing: "0.28em", textTransform: "uppercase", margin: "0 0 3px" }}>HORÁRIO</Text>
                      <Text style={{ color: gold, fontSize: 20, fontWeight: 800, margin: 0 }}>{timeLabel}</Text>
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          {/* Warning */}
          <Section style={{ backgroundColor: `${gold}0d`, border: `1px solid ${gold}25`, padding: "12px 16px", marginBottom: 24 }}>
          ...
          <Section style={{ textAlign: "center" }}>
            ...
            <Text style={{ color: `${textMuted}80`, fontSize: 10, margin: "4px 0 0" }}>
              Você recebe este lembrete por ter um agendamento marcado.
            </Text>
          </Section>
